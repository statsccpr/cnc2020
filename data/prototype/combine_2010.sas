...
/* */
libname cacensus '...\project\census';
data work.header;
infile '...\project\census\cageo2010.pl' lrecl = 500 missover pad;
INPUT
...
run;
data work.part1;
infile '...\Documents\project\census\ca000012010.pl' lrecl = 20000 dlm=',' dsd missover pad;
...
run;
data work.part2;
infile '...\project\census\ca000022010.pl' lrecl=20000 dlm=',' dsd missover pad;
LENGTH FILEID $6 /*File Identification*/
STUSAB $2 /*State/US-Abbreviation (USPS)*/
CHARITER $3 /*Characteristic Iteration*/
CIFSN	$2 /*Characteristic Iteration File Sequence Number*/
